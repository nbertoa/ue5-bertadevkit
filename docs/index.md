...
BertaDevKit is a personal Unreal Engine 5.8 repository for R&D, prototyping, debugging, tooling, and validation. It contains a development host with six independent sibling plugins:
...
Build the target project and enable the copied plugin in Unreal's Plugins window. BertaDualSense and BertaDesktopCapture are Win64-only; the other plugins have the UE 5.8 module boundaries and verification scope described in their documentation.
