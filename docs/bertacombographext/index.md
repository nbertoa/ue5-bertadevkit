...
- **EffectContext Compatibility:** verifies both configured-globals inheritance and the struct actually allocated by those globals; it never rewrites config.
...
No runtime behavior was verified in Unreal during this implementation. See the plugin [README](../../BertaDevKitHost/Plugins/BertaComboGraphExt/README.md) for the exact contracts.
