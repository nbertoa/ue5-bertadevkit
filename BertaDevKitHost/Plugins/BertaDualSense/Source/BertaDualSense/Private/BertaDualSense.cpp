...
class FBertaDualSenseInputDevice final : public IInputDevice
{
	...
	private:
		...
		static void ResistanceTrigger(Uint8 (&E)[TriggerEffectSize],int32 StartPosition,int32 StartStrength) { FeedbackTrigger(E, StartPosition, StartStrength); }
